...
function Base.setproperty!(t::FilmCharactersConnection, sym::Symbol, val::Any)
    if sym === Symbol("characters")
        setfield!(t, Symbol("characters"), val::Union{Vector{Union{Person, Missing, Nothing}}, Missing, Nothing})
    else
        setfield!(t, sym, val)
    end
end
...
function Base.setproperty!(t::StarshipFilmsConnection, sym::Symbol, val::Any)
    if sym === Symbol("films")
        setfield!(t, Symbol("films"), val::Union{Vector{Union{Film, Missing, Nothing}}, Missing, Nothing})
    else
        setfield!(t, sym, val)
    end
end
...
function Base.setproperty!(t::StarshipPilotsConnection, sym::Symbol, val::Any)
    if sym === Symbol("pilots")
        setfield!(t, Symbol("pilots"), val::Union{Vector{Union{Person, Missing, Nothing}}, Missing, Nothing})
    else
        setfield!(t, sym, val)
    end
end
...
function Base.setproperty!(t::FilmVehiclesConnection, sym::Symbol, val::Any)
    if sym === Symbol("vehicles")
        setfield!(t, Symbol("vehicles"), val::Union{Vector{Union{Vehicle, Missing, Nothing}}, Missing, Nothing})
    else
        setfield!(t, sym, val)
    end
end
...
function Base.setproperty!(t::FilmPlanetsConnection, sym::Symbol, val::Any)
    if sym === Symbol("planets")
        setfield!(t, Symbol("planets"), val::Union{Vector{Union{Planet, Missing, Nothing}}, Missing, Nothing})
    else
        setfield!(t, sym, val)
    end
end
...
function Base.setproperty!(t::SpeciesPeopleConnection, sym::Symbol, val::Any)
    if sym === Symbol("people")
        setfield!(t, Symbol("people"), val::Union{Vector{Union{Person, Missing, Nothing}}, Missing, Nothing})
    else
        setfield!(t, sym, val)
    end
end
